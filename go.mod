...
require (
	...
	knative.dev/client v0.31.1-0.20220505014215-94a5352da164
)
...
require (
	...
	knative.dev/networking v0.0.0-20220429044653-591d2bb63aae // indirect
	knative.dev/serving v0.31.1-0.20220429200154-f6cb424aaae3 // indirect
