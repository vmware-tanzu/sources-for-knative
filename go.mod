...
require (
	...
	knative.dev/eventing v0.16.1-0.20200810160130-a54347292b52
	knative.dev/pkg v0.0.0-20200810172230-c903170f4193
	knative.dev/test-infra v0.0.0-20200810174730-4ac247cc9720 // indirect
)
