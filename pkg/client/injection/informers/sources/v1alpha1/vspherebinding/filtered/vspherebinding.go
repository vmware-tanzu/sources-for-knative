...
func Get(ctx context.Context, selector string) v1alpha1.VSphereBindingInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/vmware-tanzu/sources-for-knative/pkg/client/informers/externalversions/sources/v1alpha1.VSphereBindingInformer with selector %s from context.", selector)
	}
