...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1alpha1.HorizonSource, desired *v1alpha1.HorizonSource) error {
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.HorizonSource, desiredFinalizers sets.String) (*v1alpha1.HorizonSource, error) {
	// Don't modify the informers copy.
